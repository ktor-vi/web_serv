...
std::string HandleRequests::createGetResponseHeader(size_t contentLength, const std::string &contentType, const std::string &statusCode)
{
	...
	std::cout << std::endl << "-------------------------" << std::endl << ">>> HTTP GET RESPONSE <<< " << std::endl << header.c_str() << "-------------------------" << std::endl;
	return (header.c_str)();
}
